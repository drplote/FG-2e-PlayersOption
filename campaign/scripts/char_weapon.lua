...
--Debug.console("char_Weapon.lua","onAttackAction","rActor",rActor);    
  ...
  rAction.sWeaponType = WeaponManagerPO.getWeaponType(nodeWeapon); -- NOTE: This is the only line different than the base 2E implementation
  Debug.console("rAction", rAction);
