...
function onInit()
    ...
    OptionsManager.registerCallback(PlayerOptionManager.sHideEnemiesFromPlayerCT, onHideEnemiesOptionChanged);
end
...
function onClose()
    ...
    OptionsManager.unregisterCallback(PlayerOptionManager.sHideEnemiesFromPlayerCT, onHideEnemiesOptionChanged);
end
...
function onHideEnemiesOptionChanged()
    applyFilter(true);
end
