...
_tModifierWindowPresets = {{
    ...
    tPresets = {"calledshot_abdomen", "calledshot_arm", "calledshot_head", "calledshot_leg", "calledshot_tail",
                "calledshot_torso", "calledshot_neck", "calledshot_eye", "calledshot_groin", "calledshot_hand"}
}};
