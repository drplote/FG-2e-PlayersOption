...
function onDetectMagic(sCmd, sParams)
	...
	if not bValidParams then
		ChatManagerPO.deliverChatMessage("Usage: /detectmagic [#markItemsAsMagical (0 or 1)] [#dmonly (0 or 1)]\rExample: /detectmagic 1 0 would mark items as magical and show the output to everyone.");
		return;
	end
