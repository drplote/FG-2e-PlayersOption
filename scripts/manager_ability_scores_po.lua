...
function getHonorProperties(nodeChar)
    ...
    if nScore < DataCommonPO.aHonorThresholdsByLevel[nSaneLevel][1] then
        ...
        nHonorState = -1;
    elseif nScore >= DataCommonPO.aHonorThresholdsByLevel[nSaneLevel][2] and nScore <=
        DataCommonPO.aHonorThresholdsByLevel[nSaneLevel][3] then
...
function getComelinessProperties(nodeChar)
    local nScore = DB.getValue(nodeChar, "abilities.comeliness.total",
        DB.getValue(nodeChar, "abilities.comeliness.score", 0));
...
function getHackmasterStrengthProperties(nodeChar)
    ...
    local nPercent = DB.getValue(nodeChar, "abilities.strength.percenttotal",
        DB.getValue(nodeChar, "abilities.strength.percenttotal", 0));
...
function getHackmasterDexterityProperties(nodeChar)
    ...
    local nPercent = DB.getValue(nodeChar, "abilities.dexterity.percenttotal",
        DB.getValue(nodeChar, "abilities.dexterity.percenttotal", 0));
