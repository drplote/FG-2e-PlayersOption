...
if not nRollValue then nRollValue = DiceManagerPO.getDieResult(2); end
...
function getRandomClass(nRollValue)
	if not nRollValue then nRollValue = DiceManagerPO.getDieResult(20); end
	...
	else return getRandomClass(DiceManagerPO.getDieResult(19)) .. " and " .. getRandomClass(DiceManagerPO.getDieResult(19));
	end
end
...
function getSuperstition(nRollValue)
	...
	else return getSuperstition(DiceManagerPO.getDieResult(19)) .. " Additionally, " .. getSuperstition(DiceManagerPO.getDieResult(19));
	end
end
