...
function registerOptions()
    ...
    OptionsManager.registerOption2(sCritOptionKey, false, "option_header_po", "option_label_critical_hits",
        "option_entry_cycler", {
            labels = "option_val_nat18AndHitBy5|option_val_nat20AndHitBy5|option_val_anyNat20",
            values = "nat18OrBetterAndHitBy5|nat20andHitBy5|anyNat20",
            baselabel = "option_val_off",
            baseval = "off",
            default = "off"
        });
    OptionsManager.registerOption2(sPhasedInitiativeOptionKey, false, "option_header_po",
        "option_label_phased_initiative", "option_entry_cycler", {
    ...
    OptionsManager.registerOption2(sStricterResistanceOptionKey, false, "option_header_automation",
        "option_label_stricter_resistance", "option_entry_cycler", {
            labels = "option_val_on",
            values = "on",
            baselabel = "option_val_off",
            baseval = "off",
    ...
    OptionsManager.registerOption2(sGenerateHitLocationsOptionKey, false, "option_header_automation",
        "option_label_generate_hit_locations", "option_entry_cycler", {
            labels = "option_val_po|option_val_hm",
            values = "hm|po",
            baselabel = "option_val_off",
            baseval = "off",
            default = "off"
    ...
    OptionsManager.registerOption2(sDefaultPcInitTo99OptionKey, false, "option_header_automation",
        "option_label_default_pc_init_to_99", "option_entry_cycler", {
            labels = "option_val_on",
            values = "on",
            baselabel = "option_val_off",
            baseval = "off",
    ...
    OptionsManager.registerOption2(sDefaultNpcInitTo99OptionKey, false, "option_header_automation",
        "option_label_default_npc_init_to_99", "option_entry_cycler", {
            labels = "option_val_on",
            values = "on",
            baselabel = "option_val_off",
            baseval = "off",
    ...
    OptionsManager.registerOption2(sRingBellOnRoundStartOptionKey, false, "option_header_automation",
        "option_label_ring_bell_on_round_start", "option_entry_cycler", {
            labels = "option_val_on",
            values = "on",
            baselabel = "option_val_off",
            baseval = "off",
    ...
    OptionsManager.registerOption2(sAdjustNpcAcLikePc, false, "option_header_automation", "option_label_npc_ac_like_pc",
        "option_entry_cycler", {
            labels = "option_val_on",
            values = "on",
            baselabel = "option_val_off",
    ...
    OptionsManager.registerOption2(sAllowPlayerCheaterDice, false, "option_header_automation",
        "option_label_allow_player_cheater_dice", "option_entry_cycler", {
            labels = "option_val_on",
            values = "on",
            baselabel = "option_val_off",
            baseval = "off",
    ...
    OptionsManager.registerOption2(sAlternateTargetEffectModifiers, false, "option_header_automation",
        "option_label_alternate_target_effect_modifiers", "option_entry_cycler", {
            labels = "option_val_on",
            values = "on",
            baselabel = "option_val_off",
            baseval = "off",
    ...
    OptionsManager.registerOption2(sDebugOptionKey, false, "option_header_automation",
        "option_label_show_debug_messages", "option_entry_cycler", {
            labels = "option_val_chat|option_val_console",
            values = "chat|console",
            baselabel = "option_val_off",
            baseval = "off",
            default = "off"
    ...
    OptionsManager.registerOption2(sHideEnemiesFromPlayerCT, false, "option_header_automation",
        "option_label_hide_enemies_from_player_ct", "option_entry_cycler", {
            labels = "option_val_on",
            values = "on",
            baselabel = "option_val_off",
            baseval = "off",
    ...
    OptionsManager.registerOption2(sCalculatedHealBelowZero, false, "option_header_automation",
        "option_label_calculated_heal_below_zero", "option_entry_cycler", {
            labels = "option_val_on",
            values = "on",
            baselabel = "option_val_off",
            baseval = "off",
    ...
    OptionsManager.registerOption2(sAlternateDmgxOptionKey, false, "option_header_automation",
        "option_label_alternate_dmgx", "option_entry_cycler", {
            labels = "option_val_on",
            values = "on",
            baselabel = "option_val_off",
            baseval = "off",
    ...
    OptionsManager.registerOption2(sMagicArmorEncumbranceKey, false, "option_header_automation",
        "option_label_magic_armor_encumbrance", "option_entry_cycler", {
            labels = "option_val_off|option_val_half|option_val_full",
            values = "off|half|full",
            baselabel = "option_val_off",
            baseval = "off",
            default = "off"
        });

    OptionsManager.registerOption2(sMoraleTrackerKey, false, "option_header_automation", "option_label_morale_tracker",
        "option_entry_cycler", {
            labels = "option_val_on",
            values = "on",
            baselabel = "option_val_off",
    ...
    -- House rules
    OptionsManager.registerOption2(sHackmasterStatScaling, false, "option_header_house_rule",
        "option_label_hackmaster_stat_scaling", "option_entry_cycler", {
            labels = "option_val_on",
            values = "on",
            baselabel = "option_val_off",
            baseval = "off",
    ...
    OptionsManager.registerOption2(sHackmasterAttackMatrixOptionKey, false, "option_header_house_rule",
        "option_label_hackmaster_attack_matrix", "option_entry_cycler", {
            labels = "option_val_on",
            values = "on",
            baselabel = "option_val_off",
            baseval = "off",
    ...
    OptionsManager.registerOption2(sKickerOptionKey, false, "option_header_house_rule", "option_label_hp_kicker",
        "option_entry_cycler", {
            labels = "option_val_off|option_val_on|option_val_size_based",
            values = "off|on|sizedBasedKicker",
            baselabel = "option_val_off",
            baseval = "off",
            default = "off"
        });

    OptionsManager.registerOption2(sPenetrationOptionKey, false, "option_header_house_rule",
        "option_label_penetration_dice", "option_entry_cycler", {
            labels = "option_val_on",
            values = "on",
            baselabel = "option_val_off",
            baseval = "off",
    ...
    OptionsManager.registerOption2(sArmorDamageOptionKey, false, "option_header_house_rule",
        "option_label_armor_damage", "option_entry_cycler", {
            labels = "option_val_on",
            values = "on",
            baselabel = "option_val_off",
            baseval = "off",
    ...
    OptionsManager.registerOption2(sThresholdOfPainOptionKey, false, "option_header_house_rule",
        "option_label_threshold_of_pain", "option_entry_cycler", {
            labels = "option_val_on",
            values = "on",
            baselabel = "option_val_off",
            baseval = "off",
    ...
    OptionsManager.registerOption2(sReactionAdjAffectsInit, false, "option_header_house_rule",
        "option_label_reaction_adj_affects_init", "option_entry_cycler", {
            labels = "option_val_on",
            values = "on",
            baselabel = "option_val_off",
            baseval = "off",
    ...
    OptionsManager.registerOption2(sFumbleOptionKey, false, "option_header_house_rule", "option_label_fumble_table",
        "option_entry_cycler", {
            labels = "option_val_hm_fumbles|option_val_ct_fumbles",
            values = "hmFumbles|ctFumbles",
            baselabel = "option_val_off",
            baseval = "off",
            default = "off"
        });

    OptionsManager.registerOption2(sFatigueOptionKey, false, "option_header_house_rule",
        "option_label_hackmaster_fatigue", "option_entry_cycler", {
            labels = "option_val_on",
            values = "on",
            baselabel = "option_val_off",
            baseval = "off",
    ...
    OptionsManager.registerOption2(sAddComeliness, false, "option_header_house_rule", "option_label_comeliness",
        "option_entry_cycler", {
            labels = "option_val_on",
            values = "on",
            baselabel = "option_val_off",
    ...
    OptionsManager.registerOption2(sEnableHonor, false, "option_header_house_rule", "option_label_honor",
        "option_entry_cycler", {
            labels = "option_val_on",
            values = "on",
            baselabel = "option_val_off",
    ...
    OptionsManager.registerOption2(sHackmasterCalledShots, false, "option_header_house_rule",
        "option_label_hackmaster_called_shots", "option_entry_cycler", {
            labels = "option_val_on",
            values = "on",
            baselabel = "option_val_off",
            baseval = "off",
    ...
    OptionsManager.registerOption2(sHackmasterCritsOptionKey, false, "option_header_house_rule",
        "option_label_hm_critical_hits", "option_entry_cycler", {
            labels = "option_val_nat20AndHitBy5|option_val_anyNat20",
            values = "nat20andHitBy5|anyNat20",
            baselabel = "option_val_off",
            baseval = "off",
            default = "off"
        });

    OptionsManager.registerOption2(sHackmasterInitKey, false, "option_header_house_rule", "option_label_hm_init",
        "option_entry_cycler", {
            labels = "option_val_on",
            values = "on",
            baselabel = "option_val_off",
    ...
    OptionsManager.registerOption2(sMagicArmorDamageOptionKey, false, "option_header_house_rule",
        "option_label_magic_armor_damage", "option_entry_cycler", {
            labels = "option_val_equal_magic|option_val_penetration|option_val_both",
            values = "magic|penetration|both",
            baselabel = "option_val_off",
            baseval = "off",
            default = "off"
        });

    OptionsManager.registerOption2(sMoreDurableMagicShields, false, "option_header_house_rule",
        "option_label_more_durable_magic_shields", "option_entry_cycler", {
            labels = "option_val_on",
            values = "on",
            baselabel = "option_val_off",
            baseval = "off",
    ...
    OptionsManager.registerOption2(sCoinWeightOptionKey, false, "option_header_house_rule", "option_label_coin_weight",
        "option_entry_cycler", {
            labels = "option_val_on",
            values = "on",
            baselabel = "option_val_off",
    ...
    OptionsManager.registerOption2(sRadiantNecroticArmor, false, "option_header_house_rule",
        "option_label_radiant_necrotic_armor", "option_entry_cycler", {
            labels = "option_val_on",
            values = "on",
            baselabel = "option_val_off",
            baseval = "off",
...
function shouldUseAlternateDmgx()
    return OptionsManager.isOption(sAlternateDmgxOptionKey, "on");
end

function shouldTreatDeathsDoorHealingSameAsAllOtherHealing()
    return OptionsManager.isOption(sCalculatedHealBelowZero, "on");
end
...
function isMagicArmorDamagedByPenetration()
    return OptionsManager.isOption(sMagicArmorDamageOptionKey, "penetration") or
               OptionsManager.isOption(sMagicArmorDamageOptionKey, "both");
end

function isMagicArmorDamagedByEqualMagic()
    return OptionsManager.isOption(sMagicArmorDamageOptionKey, "magic") or
               OptionsManager.isOption(sMagicArmorDamageOptionKey, "both");
end
...
function mustCritHitBy5()
    return OptionsManager.isOption(sCritOptionKey, "nat18OrBetterAndHitBy5") or
               OptionsManager.isOption(sCritOptionKey, "nat20andHitBy5") or
               OptionsManager.isOption(sHackmasterCritsOptionKey, "nat20andHitBy5");
end
...
function isHpKickerEnabled()
    return OptionsManager.isOption(sKickerOptionKey, "on") or
               OptionsManager.isOption(sKickerOptionKey, "sizedBasedKicker");
end
