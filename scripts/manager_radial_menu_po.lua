...
function initCombatTrackerActorMenu(control)
    ...
    control.registerMenuItem(Interface.getString("add_effect_menuitem") ..
                                 Interface.getString("restrained_effect_menuitem"), "addEffectIcon", 3, 1, 2);
    control.registerMenuItem(Interface.getString("remove_effect_menuitem") ..
                                 Interface.getString("restrained_effect_menuitem"), "removeEffectIcon", 3, 1, 8);
    control.registerMenuItem(Interface.getString("unconscious_effect_menuitem"), "unconsciousEffectIcon", 3, 2);
    control.registerMenuItem(Interface.getString("add_effect_menuitem") ..
                                 Interface.getString("unconscious_effect_menuitem"), "addEffectIcon", 3, 2, 2);
    control.registerMenuItem(Interface.getString("remove_effect_menuitem") ..
                                 Interface.getString("unconscious_effect_menuitem"), "removeEffectIcon", 3, 2, 8);
    control.registerMenuItem(Interface.getString("prone_effect_menuitem"), "proneEffectIcon", 3, 3);
    control.registerMenuItem(Interface.getString("add_effect_menuitem") .. Interface.getString("prone_effect_menuitem"),
        "addEffectIcon", 3, 3, 2);
    control.registerMenuItem(Interface.getString("remove_effect_menuitem") ..
                                 Interface.getString("prone_effect_menuitem"), "removeEffectIcon", 3, 3, 8);
    control.registerMenuItem(Interface.getString("stunned_effect_menuitem"), "stunnedEffectIcon", 3, 4);
    control.registerMenuItem(Interface.getString("add_effect_menuitem") ..
                                 Interface.getString("stunned_effect_menuitem"), "addEffectIcon", 3, 4, 4);
    control.registerMenuItem(Interface.getString("remove_effect_menuitem") ..
                                 Interface.getString("stunned_effect_menuitem"), "removeEffectIcon", 3, 4, 6);
    control.registerMenuItem(Interface.getString("blind_effect_menuitem"), "blindEffectIcon", 3, 5);
    control.registerMenuItem(Interface.getString("add_effect_menuitem") .. Interface.getString("blind_effect_menuitem"),
        "addEffectIcon", 3, 5, 2);
    control.registerMenuItem(Interface.getString("remove_effect_menuitem") ..
                                 Interface.getString("blind_effect_menuitem"), "removeEffectIcon", 3, 5, 8);
    control.registerMenuItem(Interface.getString("invisible_effect_menuitem"), "invisibleEffectIcon", 3, 6);
    control.registerMenuItem(Interface.getString("add_effect_menuitem") ..
                                 Interface.getString("invisible_effect_menuitem"), "addEffectIcon", 3, 6, 4);
    control.registerMenuItem(Interface.getString("remove_effect_menuitem") ..
                                 Interface.getString("invisible_effect_menuitem"), "removeEffectIcon", 3, 6, 6);
    control.registerMenuItem(Interface.getString("no_dexterity_effect_menuitem"), "noDexterityEffectIcon", 3, 8);
    control.registerMenuItem(Interface.getString("add_effect_menuitem") ..
                                 Interface.getString("no_dexterity_effect_menuitem"), "addEffectIcon", 3, 8, 2);
    control.registerMenuItem(Interface.getString("remove_effect_menuitem") ..
                                 Interface.getString("no_dexterity_effect_menuitem"), "removeEffectIcon", 3, 8, 8);
